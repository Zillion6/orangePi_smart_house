...
struct gdevice bed_room_led_dev = {
    .dev_name = "BR led",
    .key = 0x42,
    .gpio_pin = 5,
    .gpio_mode = OUTPUT,
...
struct gdevice* add_bed_room_led_dev_to_gdevice_list(struct gdevice *phead)
{
    return add_device_to_gdevice_list(phead, &bed_room_led_dev);
}